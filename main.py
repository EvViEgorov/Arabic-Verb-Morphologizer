...
def forms(text): #функция, вызывающая нажатием клавиши вывод формы
    input_text = document.querySelector("#user_input")
    became = input_text.value
    output_div = document.querySelector("#output")
    output_div.innerText = user_get_form(became)
def paradigms(text): #функция, вызывающая нажатием клавиши вывод парадигмы
    input_text = document.querySelector("#user_input")
    became = input_text.value
    output_div = document.querySelector("#output")
    output_div.innerText = user_build_paradigm(became)    
